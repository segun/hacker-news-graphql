    ...
    <BlankLayout>
      ...
      >
        <span style={spanStyle}>
          Y Combinator has adopted the following policy toward copyright infringement on the
          Services in accordance with the Digital Millennium Copyright Act (a copy of which is
          located at{' '}
        </span>
      ...
      <p className="MsoNormal" style={paragraphStyle2}>
        <span style={spanStyle}>
          ...
          (“Services”) infringes a copyright, please send a written notice (by fax or regular mail)
          to the Designated Agent at the address below.{' '}
          <b>You may not communicate the information specified below by email. </b>Please note that
          you will be liable for damages (including costs and attorney’s fees) if you materially
          misrepresent that material is infringing your copyright(s). Please use the following
          format (including section numbers) when you send written notice to us:{' '}
        </span>
      </p>
      <ol style={{ marginTop: '0in' }} start={1} type="1">
        ...
        <li className="MsoNormal" style={liStyle}>
          <span style={liSpanStyle}>
            ...
            with sufficient detail so that Y Combinator is capable of finding it and verifying its
            existence.
          </span>
        </li>
        <li className="MsoNormal" style={liStyle}>
        ...
        <li className="MsoNormal" style={liStyle}>
          <span style={liSpanStyle}>
            A statement that the Notifying Party has a good faith belief that the material is not
        ...
        <li className="MsoNormal" style={liStyle}>
          <span style={liSpanStyle}>
            ...
            accurate and that the Notifying Party is either the copyright owner, or authorized to
            make the complaint on behalf of the copyright owner.
          </span>
        </li>
        <li className="MsoNormal" style={liStyle}>
          <span style={liSpanStyle}>
            A signature of the copyright owner, or a person authorized to act on behalf of the owner
      ...
      <p className="MsoNormal" style={paragraphStyle2}>
        <span style={spanStyle}>
          After removing material pursuant to a valid DMCA notice, Y Combinator will notify the
          Subscriber responsible for the allegedly infringing material that it has removed or
          disabled access to the material. Y Combinator reserves the right, in its sole discretion,
          to immediately terminate the account of any Subscriber who is the subject of repeated DMCA
          notifications.
        </span>
      </p>
      <p className="MsoNormal" style={paragraphStyle}>
      ...
      <p className="MsoNormal" style={paragraphStyle2}>
        <span style={spanStyle}>
          ...
          counter-notification with Y Combinator by providing the following information to the
      ...
      <ul style={{ listStyleType: 'disc', marginTop: '0in' }}>
        <li className="MsoNormal" style={liStyle}>
          <span style={liSpanStyle}>
            The specific URLs of material that Y Combinator has removed or to which Y Combinator has
            disabled access.
          </span>
        </li>
        <li className="MsoNormal" style={liStyle}>
          <span style={liSpanStyle}>Your name, address, telephone number, and email address.</span>
        </li>
        <li className="MsoNormal" style={liStyle}>
          <span style={liSpanStyle}>
            A statement that you consent to the jurisdiction of Federal District Court for the
            judicial district in which your address is located (or the federal district courts
            located in San Francisco, CA if your address is outside of the United States), and that
      ...
      <p className="MsoNormal" style={paragraphStyle2}>
        <span style={spanStyle}>
          Upon receipt of a valid counter-notification, Y Combinator will forward it to Notifying
          Party who submitted the original DMCA notification. The original Notifying Party (or the
          copyright holder he or she represents) will then have ten (10) days to notify us that he
          or she has filed legal action relating to the allegedly infringing material. If Y
          Combinator does not receive any such notification within ten (10) days, we may restore the
